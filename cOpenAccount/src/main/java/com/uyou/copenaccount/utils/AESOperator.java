...
public class AESOperator {
    ...
    private AESOperator(String sKey, String ivParameter) {
		this.ivParameter = ivParameter;
		this.sKey = sKey;
    }

    public static AESOperator getInstance(String sKey, String ivParameter) {
    	
//        if (instance == null)
            instance = new AESOperator(sKey,ivParameter);
        return instance;
    }
